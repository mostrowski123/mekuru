...
void main() {
  ...
  test(
    'prefix search keeps the shortest match even when inserted last, '
  ...
  test(
    'glossary search keeps the tightest gloss match even when inserted '
    'last, beyond the LIMIT cap',
    () async {
      final dictId = await repo.insertDictionary('Dict');
